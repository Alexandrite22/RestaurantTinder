...
INSERT INTO party (location, date, owner, description, name_of_party, invite_link) VALUES ('Chuck E Cheese, 7601 W Ridgewood Dr, Parma, OH 44129', '2024-12-12 12:00:00', 1, 'Peri`s Pizza party', 'Peri`s Pizza party', 'https://localhost:44315/tinder/2');
...
INSERT INTO party (location, date, owner, description, name_of_party, invite_link) VALUES ('Cleveland Botanical Garden, 11030 East Blvd, Cleveland, OH 44106', '2022-12-17 12:00:00', 1, 'Kevin`s Botanical Garden Bash', 'Kevin`s Botanical Garden date', 'https://localhost:44315/tinder/6');
